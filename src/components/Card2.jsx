        ...
        <div className='w-full h-[120px] p-2 shadow-lg rounded-lg flex justify-between'>
            <div className='w-[60%] h-full flex gap-5'>
                ...
                <div className='w-[40%] h-full flex flex-col gap-5'>
                    ...
                    <div className='w-[90px] md:w-[110px] h-[50px] flex rounded-lg overflow-hidden shadow-lg text-xl font-semibold text-green-400 border-2 border-green-300'>
                        <button className='w-[30%] h-full bg-white flex justify-center items-center cursor-pointer' onClick={() => { qty > 1 ? dispatch(DecrementQty(id)) : 1 }}>-</button>
